...
$(document).ready( () => {
    ...
    $("#go_to_datatypes").click( () => {
        //alert("test 4")
        window.location.replace("/datatypes_page");
    });
...
$(document).ready( () => {
    ...
    $("#go_to_datatypes").html("Datatypes");
...
$(document).ready( () =>{
    ...
    $(".body_context_text").css("margin", "0% 20% 2% 20%"); // top, right, bottom, left

    $("img").css("margin", "1% 25% 1% 25%");
});
...
$(document).ready( () => {
    ...
    $("#text_body_datatypes").load("text/datatypes.txt");
